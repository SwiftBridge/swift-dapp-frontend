...
export function MobileMoneyTransfer() {
    ...
    return (
        <Card className="w-full h-full bg-secondary-800 border-secondary-700 flex flex-col">
            <CardHeader>
                ...
                <CardDescription className="text-secondary-400">Send money via phone number on Celo network.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4 flex-1">
                ...
                <div className="space-y-2">
                    ...
                    <Input id="amount" placeholder="50.00" className="bg-secondary-900 border-secondary-600 text-secondary-100" />
                </div>
            </CardContent>
            <CardFooter>
                <Button onClick={handleSendMoney} disabled={isLoading} className="w-full bg-primary-600 hover:bg-primary-700 text-white">
